...
class SEResnet(nn.Module):
    ...
    def forward(self, x):
        ...
        layer1_out = self.layer1(x)  # 256 * h/4 * w/4
        layer2_out = self.layer2(layer1_out)  # 512 * h/8 * w/8
        layer3_out = self.layer3(layer2_out)  # 1024 * h/16 * w/16
        layer4_out = self.layer4(layer3_out)  # 2048 * h/32 * w/32
        return layer3_out
