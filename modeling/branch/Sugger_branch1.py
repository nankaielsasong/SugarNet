...
class Baseline(nn.Module):
    ...
    def __init__(self, num_classes, last_stride):
        ...
        self.branc1_avg_1 = nn.AdaptiveAvgPool2d(1)
        self.branc1_max_1 = nn.AdaptiveMaxPool2d(1)
        
        self.num_classes = num_classes

        self.lbn = LBNNeck(self.in_planes, self.num_classes)

        self.lbn_branch1_1 = LBNNeck(self.in_planes, self.num_classes)
        self.lbn_branch1_2 = LBNNeck(self.in_planes, self.num_classes)
        self.lbn_branch1_g = LBNNeck(self.in_planes, self.num_classes)
    ...
    def forward(self, x):
        ...
        feat2_g = self.branc1_avg_1(feat2) + self.branc1_max_1(feat2)
        ...
        if self.training:
            ...
            cl_2_g, triplet_g = self.lbn_branch1_g(feat2_g)
            cl_2_1, triplet_2_1 = self.lbn_branch1_1(feat2_1)
            cl_2_2, triplet_2_2 = self.lbn_branch1_2(feat2_2)
            return [cl_1, cl_2_g, cl_2_1, cl_2_2], [triplet_1, triplet_g, triplet_2_1, triplet_2_2]
        
        return torch.cat([self.lbn(feat1), self.lbn_branch1_1(feat2_1), self.lbn_branch1_2(feat2_2)], dim=1)
